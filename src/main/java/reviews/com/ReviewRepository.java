...
public class ReviewRepository {
    ...
    public ReviewRepository() throws MalformedURLException {
        ...
        tempReviewsList.add(new Review(17L, "Cleveland Underground Bourbon", "/images/reviewer17.jpeg", 2, "/images/reviews/review17.txt", "/images/stars/stars5.jpg",  LocalDate.of(2018, 12, 27)));
        ...
        tempReviewsList.add(new Review(19L, "Balvenie 12year", "/images/reviewer19.png", 2, "/images/reviews/review19.txt", "/images/stars/stars4.jpg",  LocalDate.of(2018, 5, 19)));
